...
class CreatingObjectWidget extends StatefulWidget {
  const CreatingObjectWidget({super.key});

  @override
  State<CreatingObjectWidget> createState() => _CreatingObjectWidgetState();
}

class _CreatingObjectWidgetState extends State<CreatingObjectWidget> {
  XFile? layoutImage;
  List<XFile> pictures = [];
  ...
  Map<String, BuildingObject> _skipObject() {
    BuildingObject object = BuildingObject(
        _city, _address, _house, _apartment, _foreManName, _isFinished);
    Map<String, BuildingObject> returnedObject = {'skip': object};
